        ...
        <section className="flex items-center justify-center h-auto">
            <header className=" w-full fixed top-0 left-0 px-4 py-3 flex items-center justify-between z-10">
                ...
                <div className="flex items-center gap-4">
                    <Button className="!rounded-full !bg-[#DDD8EB] !text-[rgba(0,0,0,0.8)] !px-2 gap-1">
                        <MdLogin />Login
                    </Button>
                    <Button className="!rounded-full !text-[rgba(0,0,0,0.8)] !px-2 gap-1">
                       <FaRegUser/> Sign Up
                    </Button>
                </div>
            ...
            <div className=" h-auto">
                <h1 className="text-center text-2xl font-[600] text-[40px] mt-20">Welcome Back!</h1>
                <p className=" text-center text-gray-600 font-[600] text-[40px] ">Sign in with your credentials.</p>
                ...
                <form className="w-full px-2 mt-3 flex flex-col items-center justify-center">
                    ...
                    <div className="w-full form-group flex items-center justify-between mb-6">
                        <FormControlLabel control={<Checkbox size="small"
                            checked={checked} onChange={handleChange} />} label="Remember me" />
                        <Link to="/forgot-password" className="!text-blue-600 text-[16px] font-[500]">Forgot Password?</Link>

                    </div>
                    <div className="w-full form-group flex items-center justify-between mb-6">
                        <p className="opacity-50">Don't have an account?</p>
                        <Link to="/sign-up" className="!text-blue-600 text-[16px] font-[500]">Sign Up</Link>
